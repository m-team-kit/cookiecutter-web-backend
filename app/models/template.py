...
class Template(Base):
    ...
    repoFile: Mapped[str] = mapped_column(index=True, nullable=False)
    title: Mapped[str] = mapped_column(nullable=False)
    summary: Mapped[str] = mapped_column(nullable=False)
    picture: Mapped[str] = mapped_column(nullable=True)
    gitLink: Mapped[str] = mapped_column(nullable=False)
    gitCheckout: Mapped[str] = mapped_column(nullable=True)
