...
VALUES
    ('bced037a-a326-425d-aa03-5d3cbc9aa3d1',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'my_template_1.json',			'My Template 1',		'Tests Cookiecutter',   5.0,	'path/to/picture.png',	'https://link-to-be-patched',	'main'),
    ('ef231acb-0ff9-4391-ab18-6cb2698b0985',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'my_template_2.json',			'My Template 2',		'Basic Cookiecutter',	null,   'path/to/picture.png',	'https://github.com/BruceEckel/HelloCookieCutter1',	'master'),
    ('8fc20f81-e0a9-471c-8008-697ce799e73b',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'my_template_3.json',			'My Template 3',		'Template example 3',	4.5,   'path/to/picture.png',	'https://some-git-link/template',	'main'),
    ('f3f35224-e35c-46a4-90d1-354646970b13',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'my_template_4.json',			'My Template 4',		'Template example 4',	null,   'path/to/picture.png',	'https://some-git-link/template',	'main'),
    ('eebb17f2-1f25-431d-94bf-b3561d8b4758',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'deephdc-master.json',			'DEEP-HDC',				'Template for developing new modules in the DEEP Platform',	null,	'wp-content/uploads/sites/2/2018/01/logo.png',	'https://github.com/deephdc/cookiecutter-deep',	'master'),
