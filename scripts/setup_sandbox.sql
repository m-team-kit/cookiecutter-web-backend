...
VALUES
    ...
    ('f3f35224-e35c-46a4-90d1-354646970b13',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'my_template_4.json',			'My Template 4',		'Template example 4',	null,   'python',	'https://picture-url/template',	'https://some-git-link/template',	'main'),
    ('eebb17f2-1f25-431d-94bf-b3561d8b4758',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'deephdc-master.json',			'DEEP-HDC',				'Template for developing new modules in the DEEP Platform',	null,   'python',	'https://deep-hybrid-datacloud.eu/wp-content/uploads/sites/2/2018/01/logo.png',	'https://github.com/deephdc/cookiecutter-deep',	'master'),
    ('479b4f69-9760-44d9-8018-b3077d0b5416',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'deephdc-child-module.json',	'DEEP-HDC Child',		'Template for developing new modules in the DEEP Platform, tailored for users performing a retraining of an existing module',	null,   'python',	'https://deep-hybrid-datacloud.eu/wp-content/uploads/sites/2/2018/01/logo.png',	'https://github.com/deephdc/cookiecutter-deep',	'child-module'),
    ('508515f1-dd27-4198-b8c3-3109b8bc06bc',	'2000-01-01 00:00:00.000',	'2020-01-01 00:00:000',	'deephdc-advanced.json',		'DEEP-HDC Advanced',	'Template for developing new modules in the DEEP Platform, makes more assumptions on how to structure projects and adds more files than those strictly needed for integration',	null,   'python',	'https://deep-hybrid-datacloud.eu/wp-content/uploads/sites/2/2018/01/logo.png',	'https://github.com/deephdc/cookiecutter-deep',	'advanced');
